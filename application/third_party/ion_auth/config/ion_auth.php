...
*/
$config['tables']['users']           = 'ci_ion_users';
$config['tables']['groups']          = 'ci_ion_groups';
$config['tables']['users_groups']    = 'ci_ion_users_groups';
$config['tables']['login_attempts']  = 'ci_ion_login_attempts';
